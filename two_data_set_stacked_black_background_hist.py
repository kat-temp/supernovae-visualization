...
plt.hist(a,b, histtype='bar', rwidth=0.8, axes=axes, label="Swift Satellite")
plt.hist(c,b, histtype='bar', rwidth=0.8, axes=axes, label="Non Swift Satellite")
plt.title("Supernovae Captured by Satellites Each Year", color=fg_color) 
